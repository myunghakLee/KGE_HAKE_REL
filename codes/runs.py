...
def main(args):
    ...
    if args.do_train:
        ...
        train_dataloader_rel = DataLoader(
            TrainDataset(data_reader, args.negative_sample_size, BatchType.REL_BATCH),
            batch_size=args.batch_size,
            shuffle=True,
            num_workers=max(1, args.cpu_num // 2),
            collate_fn=TrainDataset.collate_fn
        ...
        train_iterator = BidirectionalOneShotIterator(train_dataloader_head, train_dataloader_tail, train_dataloader_rel)
